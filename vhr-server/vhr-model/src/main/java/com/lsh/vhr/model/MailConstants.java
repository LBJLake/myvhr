...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "lsh.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "lsh.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "lsh.mail.routing.key";
}
