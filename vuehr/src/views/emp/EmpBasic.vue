        ...
        <div>
            <div style="display: flex;justify-content: space-between">
                ...
                <div>
                    ...
                    <el-button :disabled="importDataDisabled" type="success" @click="exportData" icon="el-icon-download">
                        导出数据
                    </el-button>
                ...
                <el-row style="margin-top: 10px">
                    <el-col :span="5">
                        ...
                        <el-popover
                            ...
                            <el-tree :data="allDeps" default-expand-all :props="defaultProps" @node-click="searchViewHandleNodeClick"></el-tree>
                            <div
                                    slot="reference"
                    ...
                    <el-col :span="5" :offset="4">
                        <el-button @click="showAdvanceSearchView=!showAdvanceSearchView">取消</el-button>
            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-tag type="text">{{scope.row.contractTerm}}</el-tag>年
                    </template>
                </el-table-column>
                <el-table-column
                        prop="tiptopDegree"
                    ...
                    <el-row>
                        <el-col :span="6">
                            <el-form-item label="姓名：" prop="name">
                                <el-input size="mini" prefix-icon="el-icon-edit" v-model="emp.name" placeholder="请输入员工姓名" style="width: 150px"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="5">
                    ...
                    <el-row>
                        ...
                        <el-col :span="5">
                            <el-form-item label="籍贯：" prop="nativePlace">
                                <el-input size="mini" prefix-icon="el-icon-edit" v-model="emp.nativePlace" placeholder="请输入籍贯" style="width: 120px"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item label="电子邮箱：" prop="email">
                                <el-input size="mini" prefix-icon="el-icon-message" v-model="emp.email" placeholder="请输入电子邮箱" style="width: 150px"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="7">
                            <el-form-item label="联系地址：" prop="address">
                                <el-input size="mini" prefix-icon="el-icon-edit" v-model="emp.address" placeholder="请输入联系地址" style="width: 200px"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
<!--                    第三行-->
                    <el-row>
                        ...
                        <el-col :span="7">
                            <el-form-item label="电话号码：" prop="phone">
                                <el-input size="mini" prefix-icon="el-icon-phone" v-model="emp.phone" placeholder="电话号码" style="width: 200px"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
<!--                    第四行-->
                    <el-row>
                        <el-col :span="6">
                            <el-form-item label="工号：" prop="workID">
                                <el-input disabled size="mini" v-model="emp.workID" placeholder="工号" style="width: 150px"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="5">
                        ...
                        <el-col :span="6">
                            <el-form-item label="毕业院校：" prop="school">
                                <el-input size="mini" prefix-icon="el-icon-edit" v-model="emp.school" placeholder="毕业院校名称" style="width: 150px"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="7">
                            <el-form-item label="专业名称：" prop="specialty">
                                <el-input size="mini" prefix-icon="el-icon-edit" v-model="emp.specialty" placeholder="请输入专业名称" style="width: 200px"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
<!--                    第五行-->
                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="身份证号码：" prop="idCard">
                                <el-input size="mini" prefix-icon="el-icon-edit" v-model="emp.idCard" placeholder="请输入身份证号码" style="width: 180px"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
...
<script>
    export default {
        ...
        data() {
            return {
                ...
                rules:{
                    ...
                    beginContract:[{required:true,message:'请输入合同起止日期',trigger:'blur'}],
        ...
        methods:{
            ...
            deleteEmp(data){
                this.$confirm('此操作将永远删除【'+data.name+'】, 是否继续?', '提示', {
            ...
            currentChange(currentPage){
                ...
                if(this.showAdvanceSearchView)this.initEmps('advanced');
                else this.initEmps();
            },
