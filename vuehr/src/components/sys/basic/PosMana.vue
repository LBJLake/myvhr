<template>
    <div>
        ...
        <div class="posManaMain">
            ...
            <el-button @click="deleMany" type="danger" size="small" :disabled="multipleSelection.length==0" style="margin-top: 8px">批量删除</el-button>
        </div>
...
<script>
    export default {
        ...
        mounted() {//初始化会调用mounted方法
            this.initPositions();
        },
        methods:{
            deleMany(){
                this.$confirm('此操作将永远删除【'+this.multipleSelection.length+'】条记录, 是否继续?', '提示', {
            ...
            handleDelete(index,data){
                this.$confirm('此操作将永远删除【'+data.name+'】职位, 是否继续?', '提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning'
                }).then(() => {
